...
|---|---|---|---|---|
| 640×360 down:2x                   |    3 µs (19.6×) |    6 µs (18.6×) |    6 µs (20.7×) |   32 µs  (4.4×) |
| 960×540 down:1.5x,3x              |   15 µs (23.2×) |   55 µs  (9.6×) |   69 µs  (9.0×) |  182 µs  (3.8×) |
| 1280×720 down:2x,4x               |   15 µs (27.2×) |   41 µs (16.6×) |   71 µs (11.5×) |  176 µs  (5.5×) |
| 1920×1080 down:1.5x,3x,6x         |   66 µs (25.5×) |  226 µs (12.3×) |  286 µs (11.6×) |  537 µs  (6.7×) |
| 2560×1440 down:2x,4x,8x           |   69 µs (33.0×) |  192 µs (19.6×) |  364 µs (12.2×) |  479 µs (10.4×) |
| 3840×2160 down:1.5x,3x,6x,12x     |  518 µs (18.3×) | 1512 µs  (8.9×) | 1470 µs (10.7×) | 1672 µs (10.3×) |
...
| Workload | Ryzen 9955HX (Zen 5, AVX-512) | Epyc 7302 (Zen 2, AVX2) | Xeon 6132 (Skylake, AVX2) | Xeon E5v4 (Broadwell, AVX2) |
|---|---|---|---|---|
| 1920×1080 down:2x up:2x             |  324 µs  (8.6×) |  692 µs (7.2×) |  947 µs (6.1×) |  800 µs (8.0×) |
| 1920×1080 down:1.5x,3x up:2x        |  365 µs  (9.8×) |  972 µs (6.3×) | 1144 µs (6.4×) |  979 µs (8.0×) |
| 1280×720 down:2x,4x up:2x,4x        |  493 µs  (8.9×) | 2584 µs (3.0×) | 2463 µs (3.6×) | 2119 µs (4.5×) |
