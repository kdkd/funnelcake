...
/* -----------------------------------------------------------------------
 * Thirds kernel: scale a single plane (NEON vertical + NEON horizontal)
 *
 * Vertical: NEON vrhaddq_u8 for pairwise avgs, vmull_u8/vmlal_u8 for
 *           bilinear blends (1.5x)
 * Horizontal: NEON vld3q_u8 deinterleave for bilinear 3:2 and box-of-3,
 *             vpaddlq_u8 for pairwise halving
 * ----------------------------------------------------------------------- */
 ...
 * Stores to a 48-byte aligned buffer, then reloads with deinterleave. */
